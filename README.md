...
There are currently `88` POCs here. Some are infrastructure primitives, some are realtime systems, and some are end-user product simulations. The common goal is the same: make the underlying system behavior visible enough that someone can understand the design tradeoffs quickly.
...
- `88/88` POCs have a `README.md`
- `88/88` POCs have a technical companion doc
- `79/88` POCs have an `IMPROVEMENTS.md`
