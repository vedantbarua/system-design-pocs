...
Spring Boot proof-of-concept for a Facebook-style news feed with users, follow graph, and time-ordered posts. Includes a UI and JSON endpoints.
...
2. Run the app:
   ```bash
   cd facebook-news-feed-poc
   mvn org.springframework.boot:spring-boot-maven-plugin:run
   ```
3. Open `http://localhost:8094` for the UI.
